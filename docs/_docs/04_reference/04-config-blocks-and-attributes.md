...
The OCI configuration allows you to authenticate with private OCI registries and customize connection behavior when downloading modules from OCI distribution endpoints.
